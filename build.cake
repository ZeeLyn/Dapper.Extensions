...
var version=Argument<string>("version", "2.1.1");
...
Task("UpdateVersion").DoesForEach(GetFiles("**/Dapper.Extensions*.csproj"),(file)=>{
   ...
   XmlPoke(file,"/Project/PropertyGroup/PackageTags","Dapper Extensions,DapperExtensions,Dapper,Dapper.Extensions.NetCore,Dapper.Extensions,Dapper,Extensions,DataBase,MsSql,Sql Server,MSSQL,MySql,PostgreSql,SQLite,ODBC,Cahce,Caching,Redis,Memory,Redis Caching,Memory caching");
