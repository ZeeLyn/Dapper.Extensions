...
{
    public sealed class DapperProxy : IDapper
    {
        private IDapper Dapper { get; }

        public DapperProxy(IDapper dapper, IServiceProvider serviceProvider, string connectionName = "DefaultConnection", bool enableMasterSlave = false, bool readOnly = false)
        {
            Dapper = dapper;
